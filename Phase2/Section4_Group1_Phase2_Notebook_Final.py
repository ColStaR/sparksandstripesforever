...
# MAGIC |-------------------------------------------|------------------------|---------------|--------------|------------|--------------|
# MAGIC | Revise Phase 1 Project Proposal           | 1                      | X             | X            |            |              |
# MAGIC | Raw Data EDA: Airlines                    | 2                      |               |              | X          | X            |
# MAGIC | Raw Data EDA: Stations and Weather        | 3                      | X             |              |            |              |
# MAGIC | Join Data Sets                            | 6                      |               | X            |            |              |
# MAGIC | Initial Data Pipeline Creation            | 6                      |               |              |            | X            |
# MAGIC | Model Implementation and Evaluation       | 3                      |               |              |            | X            |
# MAGIC | Join Data Sets v2                         | 6                      |               | X            |            |              |
# MAGIC | Implementing Time Series Cross Validation | 3                      | X             |              |            | X            |
# MAGIC | Feature Engineering: Lag Time Window      | 3                      |               | X            | X          |              |
# MAGIC | Feature Engineering: Time Zone Conversion | 3                      |               | X            | X          |              |
# MAGIC | Feature Engineering: Airport Tracker      | 3                      |               |              | X          |              |
# MAGIC | Feature Engineering: Flight Tracker       | 4                      |               |              | X          |              |
# MAGIC | Feature Engineering: Previously Delayed   | 4                      |               |              | X          |              |
# MAGIC | Data Cleaning, Imputation for Null Values | 3                      | X             |              |            | X            |
# MAGIC | Phase 2 Check-In Presentation Video       | 2                      |               |              |            | X            |
...
# MAGIC %md
# MAGIC 
# MAGIC ## Link to Phase 1 Notebook
# MAGIC 
...
# MAGIC %md
# MAGIC 
# MAGIC # Next Steps and Conclusions
# MAGIC 
# MAGIC Having established a joined data set, established a basic data pipeline, and created a baseline model, there is still more work to do. Our data set can benefit from further cleaning and added features as described in the "Notes about Planned Features" section. The data pipeline will be expanded with additional tasks and refinements, especially in terms of hyperparameter tuning and improving time series cross validation. And lastly, the baseline model can be improved, and the added Random Forest and Support Vector Machine models have yet to be implemented. We aim to have all of these tasks fully accomplished and implemented for Phase 3.
